...
public class Label extends JFrame implements ActionListener {
    ...
    public Label() {
        ...
        setTitle("Beverage Ordering System");
        init();
    ...
    private void init() {
        ...
        size.setSelectedIndex(0); // default small size
        size.setSize(100, 25);
        size.setLocation(100, 50);
        add(size);
        lblBev = new JLabel("Select the type of drink you want to order:");
